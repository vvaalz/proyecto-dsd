...
| 04-panel-control | 01-general | CP-146 – CP-170 | `tests-playwright/04-panel-control/01-general/` |
...
"04-panel-control" (`/sett/setting`) — Bloque B (secciones del acordeón Dashboard) completo: 18/18 secciones expandibles cubiertas (CP-150–CP-170), salvo "Consecutivos Comprobantes" que no renderiza campos en este ambiente (ver nota de cobertura abajo). Queda pendiente el tab "Tienda online" (Bloque C, ver `CLAUDE_CONTEXT.md` sección 19).
